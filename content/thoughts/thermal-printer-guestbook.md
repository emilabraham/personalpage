...
publishDate: 2026-03-20T00:00:00-07:00
---

## Overview

I've always admired people who release web toys for the anonymous public to play with.
...
I have a mini-PC on my desk that's running 24/7.
...
Claude even suggested we set up a [udev](https://www.man7.org/linux/man-pages/man7/udev.7.html) (a command I was unfamiliar with at the time) rule so that the printer auto-binds as soon as it's plugged in.
...
It created simple HTML pages for the guestbook and gallery.
This was in lieu of Claude's suggestion of setting up a React app.
React felt kind of heavy handed for this use case and I wanted it to be extremely barebones.
Finally, we setup a DNS record and pointed it to the server and secured it with a [Let's Encrypt SSL certificate](https://letsencrypt.org/getting-started/).
...
Setting up a simple web server and basic frontend is straightforward.
